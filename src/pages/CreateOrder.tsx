          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {additionalInfo && <div className="flex items-center space-x-2">
              ...
              <div className="space-y-4">
                {orderType === 'cash-collection' && <>
                    <div className="flex items-center space-x-2">
                      <Checkbox id="cash-collection" defaultChecked />
                    ...
                    <div className="flex items-center">
                      <div className="relative flex-1">
                        ...
                        <Input type="number" value={amount} onChange={e => setAmount(e.target.value)} className="pl-24" />
                      </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox id="genius-credits" checked={useGeniusCredits} onCheckedChange={checked => {
                    if (typeof checked === 'boolean') {
