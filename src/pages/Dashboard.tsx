              ...
              <Tabs defaultValue="recent-orders" className="w-full">
                <div className="border-b">
                  <TabsList className="bg-transparent h-14 w-full justify-start px-6 gap-8">
                    <TabsTrigger 
                      value="recent-orders" 
                      className="data-[state=active]:border-b-2 data-[state=active]:border-orange-500 data-[state=active]:text-gray-900 border-0 data-[state=active]:shadow-none rounded-none h-14 text-gray-600"
                    >
                      Recent Orders
                    </TabsTrigger>
                    <TabsTrigger 
                      value="upcoming-pickups" 
                      className="data-[state=active]:border-b-2 data-[state=active]:border-orange-500 data-[state=active]:text-gray-900 border-0 data-[state=active]:shadow-none rounded-none h-14 text-gray-600"
                    >
                      Upcoming Pickups
                    </TabsTrigger>
