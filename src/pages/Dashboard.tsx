      ...
      <div className="space-y-8">
        ...
        <AnimatePresence>
          ...
          duration: 0.5
            ...
            <motion.h2 className="text-3xl font-bold tracking-tight text-gray-800 dark:text-gray-100" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            ...
            <motion.p className="text-gray-500 dark:text-gray-400" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
