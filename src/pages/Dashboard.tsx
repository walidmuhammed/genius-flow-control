  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        {/* Overview Cards - Uniform, Modern, Responsive */}
        <div
          className={cn(
            "grid gap-4",
            isMobile
        ...
        >
          <DashboardCard
            ...
            className="h-[120px] min-h-[120px] sm:h-[140px] sm:min-h-[140px]"
          />
          <DashboardCard
            title="In Progress"
            ...
            subtitle="Orders filtered as In Progress"
            className="h-[120px] min-h-[120px] sm:h-[140px] sm:min-h-[140px]"
          />
          <DashboardCard
            ...
            subtitle="Orders requiring intervention"
            className="h-[120px] min-h-[120px] sm:h-[140px] sm:min-h-[140px]"
          />
          <DashboardCard
            title="Expected Cash"
