...
import { MobileFilterSheet } from '../orders/MobileFilterSheet';
...
interface CourierOrdersFilterTabsProps {
  activeTab: string;
...
export const CourierOrdersFilterTabs: React.FC<CourierOrdersFilterTabsProps> = ({
  activeTab,
  onTabChange,
  tabs
}) => {
