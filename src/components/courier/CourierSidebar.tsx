...
const CourierSidebar: React.FC<CourierSidebarProps> = ({
  className
}) => {
    ...
    >
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex h-16 items-center px-5 flex-shrink-0">
          <Link to="/dashboard/courier" className="flex items-center gap-2.5" onClick={handleMenuClick}>
            <motion.div
        ...
        <div className="flex-1 min-h-0 overflow-y-auto py-6 px-3 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
          <CourierSidebarMenu collapsed={false} onNavigate={handleMenuClick} />
        </div>
        ...
        <div className={cn(
          ...
          <Link to="/dashboard/courier/settings" onClick={handleMenuClick}>
            <motion.div
              ...
              className={cn(
                ...
                location.pathname === '/dashboard/courier/settings'
