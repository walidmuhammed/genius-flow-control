...
import { Truck, Search, Plus, MoreHorizontal, Eye, UserCheck, UserX, Trash2, Phone, Calendar, Activity } from 'lucide-react';
...
const AdminCouriersContent = () => {
  ...
  const filteredCouriers = couriers.filter(courier => courier.name.toLowerCase().includes(searchQuery.toLowerCase()) || courier.phone.includes(searchQuery));
  ...
  return <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-4">
          <div className="relative">
            ...
            <Input placeholder="Search couriers by name or phone..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-10" />
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredCouriers.map(courier => <Card key={courier.id} className="hover:shadow-lg transition-shadow">
              ...
              <div className="flex items-start justify-between">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    {courier.status === 'active' ? <DropdownMenuItem>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <Badge variant="outline" className={getStatusBadge(courier.status)}>
      ...
      {filteredCouriers.length === 0 && <Card>
