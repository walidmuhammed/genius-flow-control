...
interface AdminOrdersPageHeaderProps {
  totalOrders: number;
  searchQuery: string;
...
export const AdminOrdersPageHeader: React.FC<AdminOrdersPageHeaderProps> = ({
  totalOrders,
  searchQuery,
  onSearchChange,
  dateRange,
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            View and manage all orders from every shop ({totalOrders} orders)
          </p>
        </div>
      </div>
    </div>
...
export const AdminOrdersSearchControls: React.FC<{
  searchQuery: string;
  onSearchChange: (query: string) => void;
  dateRange: {
    from?: Date;
    ...
    <div className="p-4 sm:p-6 border-b border-gray-200/30 dark:border-gray-700/30">
      ...
      <div className="flex flex-col space-y-4 lg:hidden">
        ...
        <div className="relative">
          ...
          <Input
            placeholder="Search orders by ID, reference, customer, phone, shop..."
            value={searchQuery}
