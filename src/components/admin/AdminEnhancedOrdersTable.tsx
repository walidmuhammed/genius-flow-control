...
export const AdminEnhancedOrdersTable: React.FC<AdminEnhancedOrdersTableProps> = ({
  ...
  return (
    <div className="w-full min-w-0">
      <div className="overflow-x-auto rounded-lg border border-gray-200/30 dark:border-gray-700/30">
        <Table>
          <TableHeader>
                  ...
                  <TableCell className="w-20">
                    <div>
                      ...
                      {order.cash_collection_lbp > 0 && (
                        <div className="font-semibold text-gray-900 dark:text-gray-100 text-sm">{order.cash_collection_lbp.toLocaleString()} LBP</div>
                      )}
                    </div>
                  </TableCell>
                  <TableCell className="w-24">
