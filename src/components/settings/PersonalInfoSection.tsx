        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="flex">
                <Input id="username" value={formData.username} disabled className="rounded-r-none bg-muted" />
            ...
            <div className="space-y-2">
              ...
              <div className="flex">
                <Input id="email" value={formData.email} disabled className="rounded-r-none bg-muted" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input id="newPassword" type={showPassword ? 'text' : 'password'} value={formData.newPassword} onChange={e => setFormData(prev => ({
                ...prev,
            ...
            <div className="space-y-2">
              ...
              <Input id="confirmPassword" type={showPassword ? 'text' : 'password'} value={formData.confirmPassword} onChange={e => setFormData(prev => ({
              ...prev,
