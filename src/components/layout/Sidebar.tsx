      ...
      <div className="flex h-16 items-center px-3 border-b">
        <Link to="/" className="flex items-center gap-2">
          {!collapsed ? (
            <div className="flex items-center">
              <span className="text-xl font-bold tracking-tight text-genius-600 mr-1">
                GENIUS
              </span>
            ...
            <div className="w-8 h-8 rounded-lg bg-genius-500 flex items-center justify-center text-white font-bold text-sm">
              G
            </div>
          )}
        </Link>
        ...
        >
          <ChevronLeft className={cn(
            "h-4 w-4 transition-transform duration-300 text-genius-600",
