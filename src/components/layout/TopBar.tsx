    ...
    <div className="sticky top-0 z-30 h-16 flex items-center justify-between px-4 md:px-6 bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex items-center gap-4">
        <HoverCard openDelay={100} closeDelay={200}>
          ...
          >
            <div className="flex flex-col py-1">
              <Link to="/orders/new" className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center gap-2 text-sm transition-colors rounded-md mx-1 my-0.5">
                <Plus className="h-4 w-4 text-[#DC291E]" />
                <span>Create Order</span>
              </Link>
              <Link to="/pickups" className="px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center gap-2 text-sm transition-colors rounded-md mx-1 my-0.5">
        ...
        <HoverCard openDelay={100} closeDelay={200}>
          ...
          <HoverCardContent 
            className="w-80 p-0 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg shadow-lg"
            align="end"
          >
