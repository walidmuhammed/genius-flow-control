...
const TopBar: React.FC = () => {
  ...
  return <div className="sticky top-0 z-30 h-16 flex items-center justify-between px-4 md:px-6 border-b border-border/10 bg-background/80 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-4">
        ...
        <Button variant="default" size="sm" className="rounded-full hidden md:flex">
